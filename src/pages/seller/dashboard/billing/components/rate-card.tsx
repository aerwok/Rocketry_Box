    ...
    return (
        <div className="w-full">
            ...
            <Dialog open={showConfirmation} onOpenChange={setShowConfirmation}>
                <DialogContent className="bg-[#6D5BD0] text-white border-none">
                    <DialogHeader>
                        <DialogTitle className="text-center text-2xl font-medium text-white">
                            Your calculated Price
                        </DialogTitle>
                    </DialogHeader>
                    <div className="py-6 flex items-center justify-center gap-2 text-center">
                        <p className="text-lg">
                            Total price:
                        </p>
